...
<html lang="en">
    ...
    <body class="  ">
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title header-title">My Cart</h5>
                        <button type="button" class="close p-2 border-0" data-dismiss="modal">
                        ...
                        <div class="col">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <div>
                                    ...
                                    <p class="mb-0">You have <span class="cartb">
                                            0
                    ...
                    <div class="row m-3 
															">
                        <div class="totalcartprice m-3 text-right">

                        </div>
                        <div class="d-flex justify-content-between">

                            <a class="btn btn-primary close " type="button" data-dismiss="modal">
                                Continue Shopping
                            </a>

                            <button class="btn btn-primary w-50" type="submit">
                                checkout &nbsp; <span class="cartb badge bg-success rounded-5 p-2">
                                    0
                                </span>
                            </button>
        ...
        <!-- modal for carts  END -->
        <!-- modal for carts -->
        <div class="modal fade cart-modal" role="dialog" tabindex="-1" id="wishlist-modal">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title header-title">My Cart</h5>
        ...
        <main class="main-content">
            <div class="position-relative iq-banner">
                <!--Nav bar Start-->
                <header>
                    <aside class="mySidepanel sidebar  sidebar-base navs-rounded-all" id="mySidepanel"
                        ...
                        <div class="sidebar-body pt-0 data-scrollbar">
                            <div class="sidebar-list nav nav-tabs " id="nav-tab" role="tablist">
                                <a class="nav-link active" id="nav-all-tab" data-bs-toggle="tab"
                                    data-bs-target="#nav-all" type="list" role="tab" aria-controls="nav-all"
                                    aria-selected="false">
                                    All products
                                </a>
                                <!-- Sidebar Menu Start -->
                                <ul class="navbar-nav iq-main-menu" id="sidebar-menu">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="collapse" href="#sidebar-special"
                                            role="button" aria-expanded="false" aria-controls="sidebar-special">
                                            <i class="icon">
                                            ...
                                            <span class="item-name">Networking and Connectivity:</span>
                                            <i class="right-icon">
                                        ...
                                        <ul class="sub-nav collapse" id="sidebar-special"
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link " id="nav-modems" href="" data-bs-toggle="tab"
                                                    data-bs-target="#nav-modems-tab" type="list" role="tab"
                                                    aria-controls="nav-modems-tab" aria-selected="false">
                                                    <i class="icon">
                                                    ...
                                                    <span class="item-name">Modems</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link " href="../dashboard/special-pages/calender.html">
                                                    ...
                                                    <span class="item-name">Wi-Fi Extenders</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link " href="../dashboard/special-pages/kanban.html">
                                                    ...
                                                    <span class="item-name">Routers</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link " href="">
                                                    ...
                                                    <span class="item-name">Network Accessories</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link " href="../dashboard/special-pages/timeline.html">
                                                    ...
                                                    <span class="item-name">Cables</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="collapse" href="#Computing" role="button"
                                            aria-expanded="false" aria-controls="sidebar-user">
                                            <i class="fas fa-laptop"></i>


                                            <span class="item-name">Computing and Peripherals</span>
                                            <i class="right-icon">
                                                <svg class="icon-18" xmlns="http://www.w3.org/2000/svg" width="18"
                                                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        ...
                                        <ul class="sub-nav collapse" id="Computing" data-bs-parent="#sidebar-menu">
                                            <li class="nav-item">
                                                <a class="nav-link" href="../dashboard/auth/sign-in.html">
                                                    ...
                                                    <span class="item-name">Laptops</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="../dashboard/auth/sign-up.html">
                                                    ...
                                                    <i class="sidenav-mini-icon"> R </i>
                                                    <span class="item-name">Desktop Computers</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="../dashboard/auth/confirm-mail.html">
                                                    ...
                                                    <i class="sidenav-mini-icon"> C </i>
                                                    <span class="item-name">Monitors</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="../dashboard/auth/lock-screen.html">
                                                    ...
                                                    <i class="sidenav-mini-icon"> L </i>
                                                    <span class="item-name">Keyboards and Mice</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="../dashboard/auth/recoverpw.html">
                                                    ...
                                                    <i class="sidenav-mini-icon"> R </i>
                                                    <span class="item-name">Printers</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="collapse" href="#Accesories" role="button"
                                            aria-expanded="false" aria-controls="sidebar-user">
                                            <i class="fas fa-plug"></i>
                                            <span class="item-name">Accessories and Connectivity</span>
                                            <i class="right-icon">
                                                <svg class="icon-18" xmlns="http://www.w3.org/2000/svg" width="18"
                                                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        ...
                                        <ul class="sub-nav collapse" id="Accesories" data-bs-parent="#sidebar-menu">
                                            <li class="nav-item">
                                                <a class="nav-link " href="">
                                                    <i class="icon">
                                                        <svg class="icon-10" xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <span class="item-name">USB Cables</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link " href="">
                                                    ...
                                                    <span class="item-name">Chargers</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link " href="">
                                                    ...
                                                    <i class="sidenav-mini-icon"> U </i>
                                                    <span class="item-name">Adapters</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link " href="">
                                                    ...
                                                    <i class="sidenav-mini-icon"> U </i>
                                                    <span class="item-name">HDMI Cables</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link " href="">
                                                    ...
                                                    <i class="sidenav-mini-icon"> U </i>
                                                    <span class="item-name">Power Banks</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link " href="">
                                                    ...
                                                    <i class="sidenav-mini-icon"> U </i>
                                                    <span class="item-name">Cable Management Accessories</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="collapse" href="#utilities-error"
                                            ...
                                            <span class="item-name">Home Appliances</span>
                                            <i class="right-icon">
                                                <svg class="icon-18" xmlns="http://www.w3.org/2000/svg" width="18"
                                                    fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        ...
                                        <ul class="sub-nav collapse" id="utilities-error"
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link " href="">
                                                    ...
                                                    <span class="item-name">Refrigerators</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link " href="../dashboard/errors/error500.html">
                                                    ...
                                                    <span class="item-name">Washing Machines</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link " href="../dashboard/errors/maintenance.html">
                                                    ...
                                                    <span class="item-name">Microwaves</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link " href="../dashboard/errors/maintenance.html">
                                                    ...
                                                    <span class="item-name">Dishwashers</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link " href="../dashboard/errors/maintenance.html">
                                                    ...
                                                    <span class="item-name">Air Conditioners</span>
                                                    <a href=""><img src="images/thlogo.png" alt="" width="120px"
                                                            height="auto"></a>
                                            </li>
                                        </ul>
                                    </li>
                    ...
                    <nav class="nav navbar  navbar-expand navbar-light  fixed-top flex-nowrap firstnavbar">
                            ...
                            <a href="../dashboard/index.html" class="navbar-brand">
                                ...
                                <div class="logo-main">
                                    <div class="logo-normal">
                                        <a href="HOME2copy.php"><img src="images/thlogo.png" alt="" width="120px"
                                                height="auto"></a>
                                    </div>
                            ...
                            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                                <ul class="mb-2 navbar-nav ms-auto align-items-center navbar-list mb-lg-0">
                                    ...
                                    <li class="nav-item dropdown">
                                        <a href="#" class="search-toggle nav-link" id="dropdownMenuButton2"
                                            ...
                                            <img src="assets/images/Flag/flag001.png" class="img-fluid rounded-circle"
                                                alt="user" style="height: 15px; min-width: 15px; width: 15px" />
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <a href=/store/cart.stml" id="mail-drop" data-bs-toggle="dropdown"
                                            aria-haspopup="true" aria-expanded="false"
                                            class="cart position-relative d-inline-flex nav-link"
                                            aria-label="View your shopping cart">
                                            <i class="fas fa fa-bell fa-lg"></i>
                                            <span
                                                class="cart-basket notif d-flex align-items-center justify-content-center">
                                                0
                                            </span>
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <a class="cart position-relative d-inline-flex nav-link" type="button"
                                            data-toggle="modal" data-target="#wishlist-modal">
                                            <i class="fas fa fa-heart fa-lg"></i>
                                            <span
                                                class="cart-basket favorites d-flex align-items-center justify-content-center">
                                                0
                                            </span>
                                            <span class="bg-primary count-mail"></span>
                                        </a>
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        ?> class="cart-basket cartb  d-flex align-items-center justify-content-center"
                                                id="cart-count">
                                                <?php echo $count ?>
                                            </span>
                                            <span class="bg-primary count-mail"></span>
                                    ...
                                    <li class="nav-item dropdown">
                                        <a href=/store/cart.stml" id="mail-drop" data-bs-toggle="dropdown"
                                            ...
                                            class="cart position-relative d-inline-flex nav-link"
                                            aria-label="View your shopping cart">
                                            <i class="fas fa fa-sign-in fa-lg"></i>

                                            <span class="bg-primary count-mail"></span>
                                        </a>
                                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                            <li>
                                                <a class="dropdown-item" href="dashboard/auth/sign-in.html">Login</a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="dashboard/auth/sign-up.html">Register</a>
                                            </li>
                                            <li>
                                                <hr class="dropdown-divider" />
                                            </li>
                                            <li>
                                                <a class="dropdown-item" href="">Conitue as a guest</a>
                                            </li>
                                        </ul>
                                    ...
                                    <!-- <li class="nav-item dropdown">
										...
										>
											<img
												...
												alt="User-Profile"
												class="theme-color-default-img img-fluid avatar avatar-30 avatar-rounded"
											/>
                    ...
                    <nav
                        class="nav navbar navbar-expand  second-navbar  navbar-light bg-body-secondary  fixed-top  flex-nowrap">
                        <div class="container-fluid ">
                            <button class="openbtn" onclick="openNav()"><i class="fas fa-bars"></i></button>

                            <a href="#" class=" nav-link p-0" id="dropdownMenuButton1" data-bs-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false">
                            ...
                            <div class="p-0 sub-drop dropdown-menu dropdown-menu-start "
                                aria-labelledby="dropdownMenuButton2">
                                <div class="m-0 border-0 shadow-none card">
                                    <div class="p-0">
                                        <ul class="p-0 list-group list-group-flush">
                                            <li class="iq-sub-card list-group-item">
                                                <a class="p-0" href="#">Spanish</a>
                                            </li>
                                            <li class="iq-sub-card list-group-item">
                                                <a class="p-0" href="#">Italian</a>
                                            </li>
                                            <li class="iq-sub-card list-group-item">
                                                <a class="p-0" href="#">French</a>
                                            </li>
                                            <li class="iq-sub-card list-group-item">
                                                <a class="p-0" href="#">German</a>
                                            </li>
                                            <li class="iq-sub-card list-group-item">
                                                <a class="p-0" href="#">Japanese</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
    ...
    $(document).ready(function() {
        $(".wish-icon i").click(function(e) {
            ...
            if ($heartIcon.hasClass("fa-heart-circle-plus")) {
                $heartIcon.removeClass("fa-heart-circle-plus").addClass("fa-heart-circle-check").css(
                    "color", "green");
                showTempAlert($heartIcon, "Added to wishlist", 3000,
                    ""); // Display the alert for 3 seconds (3000 milliseconds) near the heart icon
            } else {

                $heartIcon.removeClass("fa-heart-circle-check").addClass("fa-heart-circle-plus").css(
    ...
    $(document).ready(function() {
        $(".cart-icon i").click(function(e) {
            ...
            if ($cartIcon.hasClass("fa-cart-plus")) {
                ...
                $cartIcon.removeClass("fa-check").addClass("fa-cart-plus"); // Reset color to default
